...
if(window.localStorage.getItem('excel_data') != null){
  ...
  initialState = Immutable.fromJS({
    data: [
      [{raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''},{raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''},{raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}],
      [{raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''},{raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''},{raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}],
      [{raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''},{raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''},{raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}],
      [{raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''},{raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''},{raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}],
      [{raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''},{raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''},{raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}, {raw: '', val: '', style: ''}],
...
export const DELETE_NEW_ROW = 'DELETE_NEW_ROW';
export const DELETE_NEW_COLOUMN = 'DELETE_NEW_COLOUMN';
...
export const deleteNewRow = () => ({type: DELETE_NEW_ROW});
export const deleteNewColoumn = () => ({type: DELETE_NEW_COLOUMN});
...
export const actionHandlers = {
  ...
  DELETE_NEW_ROW(state) {
    ...
    console.log('check');
    console.log(data);
    temp_data.splice(length-2,1);
    window.localStorage.setItem('excel_data', JSON.stringify(state.toJS()));
    return state.set('data', Immutable.fromJS(temp_data));
  },

  DELETE_NEW_COLOUMN(state) {
    let data = state.get('data');
    var temp_data = data.toJS();
    var row_count = temp_data[0].length;
    var col_count = temp_data.length;
    console.log(col_count);
    console.log(row_count);
    var arr = [];
    
    for (var i = 0; i < col_count; i++) {
      temp_data[i].splice(row_count-2,1);
    }
    window.localStorage.setItem('excel_data', JSON.stringify(state.toJS()));
    return state.set('data', Immutable.fromJS(temp_data));
  },
